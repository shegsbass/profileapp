...
class Profile extends Home_Controller {
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/home', $data, TRUE);
        $this->load->helper('cookie');
        $this->common_model->increase_user_hit($user_id);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/about_me', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/resume', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/portfolio', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/portfolio_details', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/blog', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/blog_post', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/contact', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('templates/'.$data['user']->layouts.'/appointment', $data, TRUE);
        $this->load->view('templates/'.$data['user']->layouts.'/index', $data);
    }
