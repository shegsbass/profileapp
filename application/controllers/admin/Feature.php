...
class Feature extends CI_Controller {
        ...
        {   
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($id != '') {
                    ...
                    $this->session->set_flashdata('msg', 'Feature Edited Successfully'); 
                } else {
    ...
    public function active($id) 
    {
        ...
        $this->session->set_flashdata('msg', 'Feature activate Successfully'); 
    ...
    public function deactive($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->admin_model->update($data, $id,'features');
        $this->session->set_flashdata('msg', 'Feature deactivate Successfully'); 
        redirect(base_url('admin/service'));
    }
