...
class Profile extends CI_Controller {
    ...
    public function update(){
        ...
        if ($_POST) {
            ...
            if(!empty($this->input->post('enable_portfolio'))){ $enable_portfolio = 1;}else{$enable_portfolio = 0;}
            if(!empty($this->input->post('enable_blog'))){ $enable_blog = 1;}else{$enable_blog = 0;}
            if(!empty($this->input->post('enable_appointment'))){ $enable_appointment = 1;}else{$enable_appointment = 0;}
            if(!empty($this->input->post('enable_service'))){ $enable_service = 1;}else{$enable_service = 0;}
            if(!empty($this->input->post('enable_followers'))){ $enable_followers = 1;}else{$enable_followers = 0;}

            if(!empty($this->input->post('enable_experience'))){ $enable_experience = 1;}else{$enable_experience = 0;}
            if(!empty($this->input->post('enable_skill'))){ $enable_skill = 1;}else{$enable_skill = 0;}
            if(!empty($this->input->post('enable_testimonial'))){ $enable_testimonial = 1;}else{$enable_testimonial = 0;}
            if(!empty($this->input->post('enable_contact'))){ $enable_contact = 1;}else{$enable_contact = 0;}
