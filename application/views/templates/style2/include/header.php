...
<meta charset="UTF-8">
<meta name="description" content="<?php echo html_escape($user->name) ?> - <?php echo html_escape($user->designation) ?>">
...
<link rel="stylesheet" href="<?php echo base_url() ?>assets/default/css/style2.css"/>
...
<div class="col-lg-3 col-md-4">
    <div class="profile" >
        ...
        <div class="col-md-12 p-0 top_15 bottom_30">
