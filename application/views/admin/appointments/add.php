        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-10">
                <label>Appointment booking info text</label>
                <textarea class="form-control" name="appointment_info" rows="2"><?php if(empty(user()->appointment_info)){echo "Before booking an appointment please check my availability";}else{echo user()->appointment_info;} ?></textarea>
            </div>
