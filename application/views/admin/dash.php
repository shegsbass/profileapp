            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h2 class="m-b-0"><?php if(!empty($puser)) {echo $puser->verified_user;}else{echo 0;} ?></h2>
                            <h5 class="text-muted m-b-0">Verified Users</h5></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            <h2 class="m-b-0"><?php if(!empty($puser)) {echo $puser->pending_user;}else{echo 0;} ?></h2>
                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            ...
                            <h5 class="text-muted m-b-0">Expire Users</h5></div>
                    </div>
                </div>
            </div>
        </div>
