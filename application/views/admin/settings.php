              ...
              <div class="active tab-pane" id="content1">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="form-group mb-40 mr-30 mt-20">
                        <label class="mt-5">Google reCaptcha</label>

                        <span class="pull-right"><input type="checkbox" name="enable_captcha" value="1" <?php if(settings()->enable_captcha == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>

                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Registration System</label>

                        <span class="pull-right"><input type="checkbox" name="enable_registration" value="1" <?php if(settings()->enable_registration == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>

                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Email Verification</label>

                        <span class="pull-right"><input type="checkbox" name="enable_email_verify" value="1" <?php if(settings()->enable_email_verify == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>

                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Enable Payment</label>

                        <span class="pull-right"><input type="checkbox" name="enable_paypal" value="1" <?php if(settings()->enable_paypal == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>

                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Blogs</label>

                        <span class="pull-right"><input type="checkbox" name="enable_blog" value="1" <?php if(settings()->enable_blog == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>

                      <div class="form-group mb-40 mr-30">
                        <label class="mt-5">Faqs</label>

                        <span class="pull-right"><input type="checkbox" name="enable_faq" value="1" <?php if(settings()->enable_faq == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                      </div>
