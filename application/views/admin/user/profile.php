                        ...
                        <div class="col-sm-5">
                            ...
                            <?php foreach ($features as $feature): ?>
                              ...
                              <div class="form-group mb-40 mr-30 mt-20">
                                ...
                                <span class="pull-right"><input type="checkbox" name="<?php echo $val; ?>" value="1" <?php if($user->$val == 1){echo 'checked';} ?> data-toggle="toggle" data-onstyle="info" data-width="100"></span>
                              </div>
