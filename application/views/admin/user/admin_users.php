          ...
          <table class="table table-hover <?php if(count($users) > 10){echo "datatable";} ?>" id="dg_table">
            ...
            <tbody>
              ...
              <tr id="row_<?php echo $user->id; ?>">
                ...
                <?php if (isset($user->payment->status) && $user->payment->status == 'expire'): ?>
                    <td><span class="label label-danger"><?php echo $user->payment->status; ?></span></td>
                  <?php elseif (isset($user->payment->status) && $user->payment->status == 'pending'): ?>
                    <td><span class="label label-warning"><?php echo $user->payment->status; ?></span></td>
                <?php else: ?>
                    <td><span class="label label-primary"><?php if(isset($user->payment->status)){echo $user->payment->status;} ?></span></td>
                <?php endif ?>
